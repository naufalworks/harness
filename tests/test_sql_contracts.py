...
class Contracts(unittest.TestCase):
    ...
    def test_schema_version_and_integrity(self):
        self.assertEqual(self.c.execute('PRAGMA user_version').fetchone()[0],int(MIGRATIONS[-1][:3]));self.assertEqual(self.c.execute('PRAGMA integrity_check').fetchone()[0],'ok')
