...
pub(crate) fn router(state: Harness) -> Router {
    let api = Router::new()
        ...
        .route(
            ...
            get(crate::api::external_history::sessions),
        )
        .route(
            "/external-history/activity",
            get(crate::api::external_history::activity),
        )
        .route(
            "/external-history/artifact",
            get(crate::api::external_history::artifact),
        )
